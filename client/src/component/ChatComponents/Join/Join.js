...
const Join = ()=> { 
    ...
    var name = decodedToken.name.split(" ").join(""); 
    name = name + decodedToken.id.toString(); 
    ...
    return (
        <div className = "joinOuterContainer">
            <div className = "joinInnerContainer"> 
                ...
                <div><input placeholder="Name" className="joinInput" type="text" value={decodedToken.name} readOnly/></div> 
            {/* <div><input placeholder="Name" className="joinInput" type="text" onChange={(event) => { setName(event.target.value) }} /></div>   */}
